...
const WirelessEarbuds = () => {
  ...
  return (
    <>
      <Head>
        <title>{t.wirelessEarbuds.title}</title>
        <meta name="description" content={t.wirelessEarbuds.metaDescription} />
      </Head>
      <Headder />
        ...
        <section className="flex flex-col md:flex-row items-center justify-between mx-auto bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 text-white min-h-[60vh] w-full px-6 py-16">
          <div className="flex-1 mb-8 md:mb-0" data-aos="fade-right">
            <h1 className="text-5xl font-extrabold mb-4 drop-shadow-lg">
              {t.wirelessEarbuds.hero.title}
            </h1>
            <p className="text-xl max-w-lg opacity-90 mb-6">
              {t.wirelessEarbuds.hero.subtitle}
            </p>
            <a
              href="#buy"
            ...
            >
              {t.wirelessEarbuds.hero.buttonLabel}
            </a>
          </div>
          <Image
            src="/earbuds-main.png"
            alt={t.wirelessEarbuds.hero.title}
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1" data-aos="fade-left">
              <h2 className="text-3xl font-bold mb-4 text-blue-700 dark:text-pink-200">
                {t.wirelessEarbuds.about.title}
              </h2>
              <p className="mb-4 text-lg text-gray-700 dark:text-gray-200 text-justify">
                {t.wirelessEarbuds.about.description1}
              </p>
              <p className="text-base text-gray-600 dark:text-gray-300">
                {t.wirelessEarbuds.about.description2}
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <Image
                  key={idx}
                  src={img}
                  alt={`${t.wirelessEarbuds.hero.title} view ${idx + 1}`}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-200 text-lg space-y-2">
                {t.wirelessEarbuds.features.map((feature, index) => (
        ...
        <section className="py-16 px-4 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {t.wirelessEarbuds.reviews.map((cust, i) => (
                <div
                  key={i}
        ...
        >
          <div className="max-w-2xl mx-auto flex flex-col items-center text-center">
            <h2 className="text-4xl font-extrabold mb-4 text-white drop-shadow-lg">
              {t.wirelessEarbuds.cta.title}
            </h2>
            <p className="mb-8 text-lg text-white/90">
              {t.wirelessEarbuds.cta.description}
            </p>
            <Link
              href="/contact-us"
            ...
            >
              {t.wirelessEarbuds.cta.buttonLabel}
            </Link>
          </div>
        </section>
      </main>
