    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <section className="flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 text-white min-h-[100vh]">
        ...
        <p className="text-lg md:text-xl max-w-2xl text-center opacity-90">
          We'd love to hear from you! Reach out for support, partnership, or any
          questions about MyShop.
        </p>
      </section>
      ...
      >
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-200">+1 800 123 4567</p>
          </div>
          <div>
            <div className="mb-2 text-blue-600 dark:text-pink-400 flex justify-center text-3xl">
              <Mail size={35} />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
              <h3 className="font-semibold mb-1">How can I track my order?</h3>
              <p className="text-gray-700 dark:text-gray-200">
                You can track your order status in your MyShop account dashboard
                under 'Orders'.
              </p>
            </div>
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-gray-700 dark:text-gray-200">
                We offer a 30-day return policy on most products. Please see our
